...
$queryOwner = "SELECT * FROM owners WHERE user_name = $1";
$resultOwner = pg_query_params($conn, $queryOwner, array($userName));
$ownerDetails = pg_fetch_assoc($resultOwner);
if (!$ownerDetails) {
...
<div class="container">
    ...
    <a href="owner_dashboard.php"><button type="button" class="back-button"> Prev Page</button>
    </form>
